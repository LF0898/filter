...
<div class="nav">
    ...
    <ul>
     	<li class="sel"><a href="index..">首  页</a></li>
        <li><a href="about_us.php">公司简介</a></li>
        <li><a href="product_list..">产品展示</a></li>
...
<div class="content">
	<div class="lefter">
        ...
        <ul class="list_l">
        	<li>
                <span class="listimg">
                    <img src="images/tran.gif" class="blank" /><a href="product_info.php"><img src="images/prod1.gif" alt="图片1" /></a>
                </span>
                <span class="listtxt"><a href="product_info.php">图片1</a></span>
            </li>
			<li>
                <span class="listimg">
                    <img src="images/tran.gif" class="blank" /><a href="product_info.php"><img src="images/prod2.gif" alt="图片2" /></a>
                </span>
                <span class="listtxt"><a href="product_info.php">图片1</a></span>
            </li>
			<li>
                <span class="listimg">
                    <img src="images/tran.gif" class="blank" /><a href="product_info.php"><img src="images/prod3.gif" alt="图片3" /></a>
                </span>
                <span class="listtxt"><a href="product_info.php">图片1</a></span>
            </li>
			<li>
                <span class="listimg">
                    <img src="images/tran.gif" class="blank" /><a href="product_info.php"><img src="images/prod4.gif" alt="图片4" /></a>
                </span>
                <span class="listtxt"><a href="product_info.php">图片4</a></span>
            </li>
        </ul>
	...
	<div class="righter">
    	<div class="rightBox">
        	<h3>产品分类</h3>
            <ul class="list_r">         	
            	<li><a href="product_list.php">类别1</a></li>
				<li><a href="product_list.php">类别2</a></li>
				<li><a href="product_list.php">类别3</a></li>
				<li><a href="product_list.php">类别4</a></li>
