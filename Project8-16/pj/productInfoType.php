...
echo $_GET['ptype'];
//$_GET['ptype'] == "布料";
$protype = array("productType" => $_GET['ptype']);
$pic     = $like->select("product", $protype);
?>
<div class="header">
...
<div class="content">
    ...
    ?>
            <ul class="list_l">
                <li>
                <span class="listimg">
                    <img src="admin/<?php echo $key['picPath']; ?>" class="blank" /><a href="product_info.php"><img src="admin/<?php echo $key['picPath']; ?>" alt="图片1" /></a>
                </span>
                    <span class="listtxt"><a href="product_info.php"><?php echo $key['productName']; ?></a></span>
                </li>
