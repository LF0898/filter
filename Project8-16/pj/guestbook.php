...
<div class="content">
	<div class="lefter">
        ...
        <div class="intro" style="padding-top:16px">
            <form action="guestbooks.php" method="post" >
        	<label>呢称：</label><input name="bookName" type="text" /><br />
			<label>内容：</label><textarea name="bookTitle" cols="" rows="" style="width:545px;height:138px"></textarea>
