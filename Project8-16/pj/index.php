...
<div class="content">
	<div class="w475_l">
        ...
        <div class="intro">
        		<?php
$tit = $like->select("company");
echo $str->strTask6($tit[" companyTitle"], 130);
?>
    ...
    <div class="w370_r">
        ...
        <ul class="list_r">
            <?php
foreach ($notice as $va) {
    ;?>
                <li><a href="noticeArticle.php<?php echo "?id=" . $va['noticeNo']; ?>"><?php echo $str->strTask6($va['noticeContent'], 16); ?> </a><span class="time2"><?php echo $va['noticeTime']; ?></span></li>
            <?php }
?>
...
foreach ($test as $val) {
    ;?>
    <li><a href="article.php<?php echo "?id=" . $val['jouralismId']; ?>"><?php echo $str->strTask6($val['jouralismTitle'], 16); ?> </a><span class="time2"><?php echo $val['jouralismTime']; ?></span></li>
<?php }
?>
