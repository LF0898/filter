...
$productid = array("productId" => $_GET['id']);
$tit       = $like->select("product", $productid);
?>
<div class="header">
...
<div class="content">
	<div class="lefter">
        ...
        <div class="product">
			<img src="admin/<?php echo $tit['picPath']; ?>" alt=" " />
			<p><strong>产品名称</strong>：<?php echo $tit['productName']; ?></p>
			<p><strong>产品描述</strong>：</p>
        	<p><?php echo $tit['productTitle']; ?></p>
        </div>
    </div>
	<div class="righter">
    	<div class="rightBox">
