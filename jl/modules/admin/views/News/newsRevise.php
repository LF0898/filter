...
<div class="container">
    ...
    <div class="mainbox">
        ...
        <form action="?r=AdminiModule/news/reviseed&nid=<?=$row['noticeNo'];?>" method="post">
            <table class="opt" style="width:600px;">
                <tbody>
                    ...
                    <tr>
                        <td>
                        <input name="title" class="txt" style="width:400px;" type="text" value="<?=$row['noticeContent'];?>">
                        </td>
                    </tr>
                    <tr>
                        <th>文章内容：<?=$row['noticeTitle'];?></th>
                    </tr>
                    <tr>
                        <td>修改：<textarea style="width:400px; height:150px" name="content"></textarea></td>
                    </tr>
                </tbody>
            </table>
