...
<body>
<div class="container">
    <h3 class="marginbot">最新公告<a href="?r=AdminiModule/news/add" class="sgbtn">添加新文章</a></h3>
    <div class="mainbox">
        <form action="?r=AdminiModule/news/delete" method="post">
            <table class="datalist fixwidth">
                <tbody>
                    ...
                    <tr>
                        <td width="80"><input name="noticeNo" value="<?php echo $row['noticeNo']; ?>" class="checkbox" type="checkbox"></td>
                        <td><strong><?=$row['noticeContent'];?></strong></td>
                        <td width="100"><?=$row['addPeople'];?></td>
                        <td width="150"><?=$row['noticeTime'];?></td>
                        <td width="100"><a href="?r=AdminiModule/news/revise&nid=<?=$row['noticeNo'];?>">编辑</a></td>
                    </tr>
                    <?php }
;?>
                    <tr class="nobg">
