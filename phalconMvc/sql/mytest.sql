...
CREATE TABLE `account` (
  ...
  `accountName` varchar(20) NOT NULL COMMENT '管理员账号名',
  `accountPwd` varchar(255) NOT NULL COMMENT '用户密码',
  ...
  `endTime` int(11) NOT NULL COMMENT '最后登录时间',
  `phoneNumber` int(11) NOT NULL COMMENT '联系手机',
  `qqNumber` int(11) NOT NULL COMMENT 'QQ号',
  PRIMARY KEY (`id`)
...
-- Records of account
-- ----------------------------
INSERT INTO `account` VALUES ('1', 'admin', '123456', '942658316@qq.com', 'admin', '超级管理', '2016', '0', '0');
INSERT INTO `account` VALUES ('2', 'ycf', '123456', '484884487@qq.com', 'qwe', '用户组', '2016', '1393478982', '5341767');
...
CREATE TABLE `admin` (
  `admNo` int(11) NOT NULL AUTO_INCREMENT COMMENT '管理员编号',
  `admUser` varchar(16) NOT NULL COMMENT '管理员账号',
  `admPaw` varchar(80) NOT NULL COMMENT '管理员密码',
  `admTime` date DEFAULT NULL COMMENT '注册时间',
  `admType` int(1) DEFAULT NULL,
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('3', ' lf', '123456', '2016-08-16', '1', '127.0.0.0');
INSERT INTO `admin` VALUES ('4', 'adm', '123456', '2016-02-02', '0', '127.0.0.0');
INSERT INTO `admin` VALUES ('6', 'fbl', 'e10adc3949ba59abbe56e057f20f883e', '2016-02-04', '1', '127.0.0.0');
INSERT INTO `admin` VALUES ('7', 'ddd', '827ccb0eea8a706c4c34a16891f84e7b', '2016-09-03', '1', '127.0.0.0');
INSERT INTO `admin` VALUES ('9', 'hhhhh', '123456', '2016-09-09', '1', '127.0.0.0');
...
CREATE TABLE `company` (
  `companyId` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '编号',
  `companyTitle` text NOT NULL COMMENT '公司简介',
  `addPeople` varchar(10) NOT NULL COMMENT '添加人',
  `addTime` varchar(18) NOT NULL COMMENT '添加时间',
...
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES ('0000000001', '在2个小时的新品发布里，苹果工作人员直接抛出iPhone 7和iPhone 7 Plus与前一代的10点不同进行了介绍。正如之前网络上流传的照片和猜测：不再有实体Home键，而是支持感压的触控Home键；iPhone 7 Plus采用了双摄像头；机身支持IP67级别防水防尘；取消了3.5mm耳机接口；无线蓝牙耳机AirPods；采用A10 Fusion芯片；标配光学防抖；32GB存储起步；电池续航时间更长等等。', '乐可', '2016-08-21');
...
CREATE TABLE `contact_us` (
  `contactsNo` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '主键',
  `mobilePhone` int(11) NOT NULL COMMENT '移动电话',
  `address` varchar(25) NOT NULL COMMENT '地址',
  `fixedPhone` varchar(15) NOT NULL COMMENT '固定电话',
  `fax` varchar(15) NOT NULL COMMENT '传真',
  `addPeople` varchar(255) NOT NULL COMMENT '添加人',
  `addTime` char(10) NOT NULL COMMENT '添加时间',
  `contacts` varchar(10) NOT NULL COMMENT '联系人',
  PRIMARY KEY (`contactsNo`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of contact_us
-- ----------------------------
INSERT INTO `contact_us` VALUES ('0000000001', '1361982998', '广东省广州市广州大道北', '020-123456', '020-123456', '农夫', '2016-3-12', '乐可');
...
CREATE TABLE `discuss` (
  ...
  `discussTitle` varchar(30) NOT NULL COMMENT '评论标题',
  `discussContent` text NOT NULL COMMENT '评论内容',
  `jouralismId` int(11) NOT NULL COMMENT '新闻Id',
  PRIMARY KEY (`id`)
...
-- Records of discuss
-- ----------------------------
INSERT INTO `discuss` VALUES ('2', '二锅头如果房地产V型', '梵蒂冈和覆盖度', '2');
INSERT INTO `discuss` VALUES ('3', '二锅头如果房地产V型', '梵蒂冈和覆盖度', '2');

-- ----------------------------
-- Table structure for jouralism
-- ----------------------------
DROP TABLE IF EXISTS `jouralism`;
CREATE TABLE `jouralism` (
  `jouralismId` int(1) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '新闻标签',
  `jouralismTitle` varchar(25) NOT NULL COMMENT '新闻标题',
  `jouralismContent` text NOT NULL COMMENT '新闻内容',
  `jouralismTime` varchar(20) NOT NULL COMMENT '新闻事件',
  PRIMARY KEY (`jouralismId`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of jouralism
-- ----------------------------
INSERT INTO `jouralism` VALUES ('1', '湖南商人被法院未判先罚900万 儿女房产被封', '尽管还未判决，商人梁材实际控制的公司，已经被湖南省辰溪县人民法院罚没900万元。\r\n\r\n2015年4月，检方指控梁材行贿296万元、应予追缴违法所得1309.9万元。让梁材不解的是，即使这些指控成立，他本人、子女及公司名下被办案机关采取措施的财产也远超这个数——除罚没的900万元外，另有896万元应收货款被冻结、3套房产被查封。其代理律师、北京京师律师事务所律师王殿学、张雪峰估算这些资产合计价值约3200万元。\r\n\r\n中国青年报·中青在线记者向办案法官询问“未判先罚900万”的原因，截至发稿未获答复。其代理律师称，法官曾告诉他们“判后会一并处理”。至于梁材及子女名下的3套房产，起诉书显示系“其无主动退缴赃款”而查封的。\r\n\r\n其代理律师认为，法院“未判先罚”有滥用职权之嫌，此外，如果查封、冻结的财产最终被证实与案件无关，检察院、法院也违反了涉案财物处置的规定。\r\n\r\n商人被指控行贿罪\r\n\r\n2009年1月1日，梁材以湖南娄底市恒成工贸有限公司（以下简称“恒成公司”）的名义与湖南华菱涟源钢铁有限公司（以下简称“涟钢公司”）签订了炼焦煤买卖合同。\r\n\r\n按照合同约定，涟钢公司2009年度计划从恒成公司采购焦煤7.2万吨 ，每月供货数量以涟钢公司当月订购通知单为准。不过，2009年2月，恒成公司未收到涟钢公司的订购通知单。', '2016年08月17日');
INSERT INTO `jouralism` VALUES ('2', '济南工地挖出东周大墓 出土数件青铜鼎与编钟', '15日，有市民致电生活日报报料：济南新东站片区梁王庄二村工地在施工时挖出了一堆青铜器。记者闻讯赶到现场并了解到，挖出青铜器的地方是一座济南范围内规模少见的东周时期大型墓葬，文物部门现场接收残缺青铜器十来件，同时对该工地下达停工通知，接下来将进行考古发掘。\r\n\r\n济南新东站片区梁王庄二村工地挖出东周大墓，还出土了编钟、鼎等宝贝？15日下午，生活日报记者闻讯赶到位于梁王庄二村的新东站片区安置房项目施工现场。只见整个新东站片区安置房项目被划分为多个区片，同时开工建设。几经打听，记者在一座尚未拆迁的二层小楼东北方基坑中，找到了文物出土现场。\r\n\r\n工地施工挖出青铜器\r\n\r\n记者远远看到，基坑之中有一处被绿色防尘网覆盖的区域，距离地面大约有6米深，在满是黏土的基坑中，散布着数块大型青石。被覆盖区域的基坑边上，站着几位来自济南市考古研究所和历城文物部门的工作人员和四五名工地人员，防尘网下也有三四名考古人员正对现场进行勘查。\r\n\r\n“那个有石头的地方就是挖出宝贝的墓室！”一位看热闹的工人告诉记者，这个工地是14日晚上进行土方作业时发现文物的，都是青铜器，有鼎和编钟，总共一二十件。“挖出的东西被包工头拿走了，我也就知道这么多，这不今天来了考古专家了嘛。”另一位貌似颇晓内情的人则悄悄说，不是14日晚上，是13日就挖出宝贝来了。', '2016年08月16日');
INSERT INTO `jouralism` VALUES ('3', '深圳88万鸽笼房走红 同价在3个省会可买豪宅', '据《证券时报》9月26日报道，昨日，深圳侨城尚寓推出的6平方米的“蜗居”开盘即被抢光的消息刷爆网络。据了解，开发商赠送了一些面积，实际使用面积大概有12平方米，各功能空间一应俱全，能满足基本的居住需求，售价达88万元。\r\n\r\n证券时报记者根据中国房地产协会公布的8月份31个全国省会（包括自治区和直辖市）住宅房价简单计算了88万在国内一线和省会城市可以买多少平方米的房子。', '');
...
CREATE TABLE `messge` (
  `messgeNo` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '留言编号',
  `messgeName` varchar(8) NOT NULL COMMENT '昵称',
  `messges` varchar(255) DEFAULT NULL COMMENT '留言内容',
  PRIMARY KEY (`messgeNo`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of messge
-- ----------------------------
INSERT INTO `messge` VALUES ('0000000001', '小号', '你好');
INSERT INTO `messge` VALUES ('0000000002', '学习', '你好');
INSERT INTO `messge` VALUES ('0000000003', '学习', '你好');
INSERT INTO `messge` VALUES ('0000000004', '小哦好', '反对法');
INSERT INTO `messge` VALUES ('0000000007', '小哦好', '反对法');
INSERT INTO `messge` VALUES ('0000000008', '说的是', '威威');
INSERT INTO `messge` VALUES ('0000000009', '威威', '得分');
INSERT INTO `messge` VALUES ('0000000010', '你好', '你好哈哈哈哈哈哈');
INSERT INTO `messge` VALUES ('0000000011', '你好', '你好哈哈哈哈哈哈');
INSERT INTO `messge` VALUES ('0000000012', '史蒂芬孙', '的说法都是广告');
...
CREATE TABLE `notice` (
  `noticeNo` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '公告编号',
  `noticeContent` text NOT NULL COMMENT '公共内容',
  `noticeTitle` varchar(25) NOT NULL COMMENT '公共标题',
  `noticeTime` varchar(20) NOT NULL COMMENT '添加时间',
  `addPeople` varchar(10) NOT NULL COMMENT '添加人',
...
-- Records of notice
-- ----------------------------
INSERT INTO `notice` VALUES ('0000000002', '上线了', '公司网站正式上线了', '16-08-19 00:30:37', 'fbl');
INSERT INTO `notice` VALUES ('0000000010', '公共测试', '开始测试', '16-08-19 00:23:41', 'fbl');
INSERT INTO `notice` VALUES ('0000000011', '恭贺新春', '新春快乐', '16-08-19 00:23:41', 'fbl');
...
CREATE TABLE `product` (
  `productId` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '产品编号',
  `productName` varchar(20) NOT NULL COMMENT '产品名称',
  `productTitle` text NOT NULL COMMENT '产品描述',
  `picPath` varchar(45) NOT NULL COMMENT '图片路径',
  `productType` varchar(8) NOT NULL COMMENT '产品类型',
  `productTime` varchar(20) NOT NULL COMMENT '添加时间',
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('0000000002', '防水布', '非常防水', 'images/prod1.gif', '布料', '2016-07-21');
INSERT INTO `product` VALUES ('0000000003', '防晒布', '非常防晒', 'images/prod2.gif', '布料', '2016-07-21');
INSERT INTO `product` VALUES ('0000000004', '卷卷布', '非常卷', 'images/prod1.gif', '布料', '2016-07-21');
INSERT INTO `product` VALUES ('0000000009', '极品布料', '非常极品', '../static/images/login.gif', '布料', '2016-09-8');
...
CREATE TABLE `product_type` (
  `typeId` int(10) unsigned zerofill NOT NULL AUTO_INCREMENT COMMENT '类型Id',
  `typeName` varchar(16) NOT NULL COMMENT '类型名称',
  `productType` varchar(16) NOT NULL COMMENT '产品类型',
  PRIMARY KEY (`typeId`)
...
-- ----------------------------
INSERT INTO `product_type` VALUES ('0000000001', '布料', '13001');
INSERT INTO `product_type` VALUES ('0000000002', '板材', '23001');
...
-- ----------------------------
INSERT INTO `productType` VALUES ('0000000001', '布料', '13001');
INSERT INTO `productType` VALUES ('0000000002', '板材', '23001');
...
-- Records of test
-- ----------------------------
INSERT INTO `test` VALUES ('0000000003', 'title2');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('0000000004', 'å·');
INSERT INTO `user` VALUES ('0000000006', '号');
INSERT INTO `user` VALUES ('0000000024', 'kk');
INSERT INTO `user` VALUES ('0000000033', '李四');
INSERT INTO `user` VALUES ('0000000034', '号');
INSERT INTO `user` VALUES ('0000000234', 'kk');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('0000000001', 'lf', 'sk@dj.com');
INSERT INTO `users` VALUES ('0000000236', 'fbl', 'gd@ssj.com');
